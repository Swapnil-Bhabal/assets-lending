...
const Footer = () => {
  return (
    <footer class="bg-black bg-gradient-to-br from-black via-indigo-500 to-black text-white body-font">
      <div class="container px-5 py-24 mx-auto flex flex-wrap md:flex-nowrap md:justify-between justify-center">
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
          <h2 class="title-font font-medium tracking-widest md:text-start text-center text-sm mb-3">
            SUBSCRIBE
          </h2>
